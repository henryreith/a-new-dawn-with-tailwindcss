  ...
  on: {
    init: function () {
      ...
      const elements = document.querySelectorAll(
        '.hero__swiper--sm .swiper-slide',
      );
      elements.forEach((element) => {
        element.classList.add('hero_slider_loaded');
      });
      const firstSlideElement = document.querySelectorAll(
        '.hero_first_slide_sm',
      );
      firstSlideElement.forEach((element) => {
        element.classList.remove('hero_first_slide_sm');
      });
      const notFirstSlideElement = document.querySelectorAll(
        '.hero_not_first_slide_sm',
      );
...
const largeSwiperConfig = {
  ...
  on: {
    init: function () {
      ...
      const lgSliderElement = document.querySelectorAll(
        '.hero__swiper--onload-o-hidden',
      );
